function Export-FileAttachment {
    ...
    $DisplayName = ($FileObject.Values | Where-Object {$_.type -match "DisplayName"}).value 
    $Content =  ($FileObject.Values | Where-Object {$_.type -match "Content"}).value # as Microsoft.EnterpriseManagement.Common.ServerBinaryStream
